data=`
    ...
    let qoutesAmount=arr.length;

    let random=Math.floor(Math.random()*qoutesAmount);

    let qouteElement= document.getElementById('quote');

    qouteElement.innerHTML=arr[random];

    console.log(qouteElement);
    console.log(arr[2]);
